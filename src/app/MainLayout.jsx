...
const MonthlyForexComparison = lazy(() =>
  import("./components/forex/container/MonthlyForexComparison")
);
        ...
        <main>
          ...
          >
            <Switch>
              ...
              <Route
                path="/forex/monthly"
                render={props => <MonthlyForex {...props} exact />}
              />
              <Route
                path="/forex/compare"
                render={props => <MonthlyForexComparison {...props} exact />}
              />
            </Switch>
          </Suspense>
        </main>
